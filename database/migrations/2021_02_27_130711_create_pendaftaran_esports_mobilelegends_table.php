...
class CreatePendaftaranEsportsMobilelegendsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pendaftaran_esports_mobilelegends', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pendaftaran_esports_mobilelegends');
    }
}
