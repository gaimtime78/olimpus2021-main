...
class CreatePendaftaranEsportsPointblankTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pendaftaran_esports_pointblank', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pendaftaran_esports_pointblank');
    }
}
