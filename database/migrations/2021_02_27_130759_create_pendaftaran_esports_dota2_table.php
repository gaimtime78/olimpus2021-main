...
class CreatePendaftaranEsportsDota2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pendaftaran_esports_dota2', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pendaftaran_esports_dota2');
    }
}
