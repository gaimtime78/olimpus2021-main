...
<form method="POST" action="{{ route('landing.keilmiahan.speech.store') }}" enctype="multipart/form-data">
	@csrf
	...
	<!-- JURUSAN PESERTA -->
	<div class="form-group">
		<label for="jurusan_angkatan_peserta">Jurusan / Angkatan Peserta (required):</label><br />
		<input id="jurusan_angkatan_peserta" type="text" name="jurusan_angkatan_peserta" value="{{ old('jurusan_angkatan_peserta') }}" class="form-control" />
	</div>
	...
	<div class="form-group">
		<label for="ktm_peserta">KTM / KRS Peserta Semester terakhir (Required):</label><br />
