...
<form method="POST" action="{{ route('landing.apresiasi.dutakampus.store') }}" enctype="multipart/form-data">
	@csrf
	...
	<!-- FORM JURUSAN PESERTA -->
	<div class="form-group">
		<label for="jurusan_peserta">Jurusan Peserta (required):</label><br />
		<input id="jurusan_peserta" type="text" name="jurusan_peserta" value="{{ old('jurusan_peserta') }}" class="form-control" />
	</div>
