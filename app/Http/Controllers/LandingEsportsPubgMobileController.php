...
class LandingEsportsPubgMobileController extends Controller
{
	...
	public function index()
	{
		...
		return view('landing.olahraga.esports.pubgmobile', [
			'api' => $api,
	...
	public function store(Request $request)
	{
		 ...
		 */
		$row_id = DB::table('pendaftaran_esports_pubgmobile')
			->insertGetId([
		...
		$nama_file = [
			'ktm' => [
				'ketua' => $ktm_ketua ? $ktm_ketua->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_1' => $ktm_anggota_1 ? $ktm_anggota_1->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_2' => $ktm_anggota_2 ? $ktm_anggota_2->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_3' => $ktm_anggota_3 ? $ktm_anggota_3->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_4' => $ktm_anggota_4 ? $ktm_anggota_4->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_cadangan' => $ktm_anggota_cadangan ? $ktm_anggota_cadangan->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
			],
			'foto' => [
				'ketua' => $foto_ketua ? $foto_ketua->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_1' => $foto_anggota_1 ? $foto_anggota_1->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_2' => $foto_anggota_2 ? $foto_anggota_2->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_3' => $foto_anggota_3 ? $foto_anggota_3->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_4' => $foto_anggota_4 ? $foto_anggota_4->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_cadangan' => $foto_anggota_cadangan ? $foto_anggota_cadangan->store('olahraga/esports/pubgmobile/' . $row_id, ["disk" => 'pendaftaran']) : "",
			],
		];
		 ...
		 */
		DB::table('pendaftaran_esports_pubgmobile')
			->where('id', '=', $row_id)
			->update([
		...
		return redirect()->route('landing.olahraga.esports.pubgmobile.success')->with('status', 'SUKSES!');
	}
	...
	public function success()
	{
		if (session('status')) {
			...
			return redirect()->route('landing.olahraga.esports.pubgmobile.index');
		}
	}
}
