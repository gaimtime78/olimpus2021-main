...
class LandingSeniTariTariTradisionalController extends Controller
{
	public $cabang_lomba = 'Tari Tradisional';
	public $whatsapp = 'https://api.whatsapp.com/send?phone=6285640641995';
	public $pamflet = 'img/senibudaya/senitari/taritradisional/pamflet_revisi2.png';
	...
	public function success() {
		if (session('status')) {
			...
			return redirect()->route('landing.senibudaya.senitari.taritradisional.index');
		}
	}
}
