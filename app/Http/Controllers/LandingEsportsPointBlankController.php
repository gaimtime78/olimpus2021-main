...
class LandingEsportsPointBlankController extends Controller
{
	public $cabang_lomba = 'Point Blank';
	public $whatsapp = 'https://api.whatsapp.com/send?phone=6281329465716';
	public $pamflet = 'img/olahraga/esports/pointblank/pamflet.jpg';
	...
	public function index()
	{
		...
		return view('landing.olahraga.esports.pointblank', [
			'api' => $api,
	...
	public function store(Request $request)
	{
		 ...
		 */
		$row_id = DB::table('pendaftaran_esports_pointblank')
			->insertGetId([
		...
		$nama_file = [
			'ktm' => [
				'ketua' => $ktm_ketua ? $ktm_ketua->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_1' => $ktm_anggota_1 ? $ktm_anggota_1->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_2' => $ktm_anggota_2 ? $ktm_anggota_2->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_3' => $ktm_anggota_3 ? $ktm_anggota_3->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_4' => $ktm_anggota_4 ? $ktm_anggota_4->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_cadangan' => $ktm_anggota_cadangan ? $ktm_anggota_cadangan->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
			],
			'foto' => [
				'ketua' => $foto_ketua ? $foto_ketua->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_1' => $foto_anggota_1 ? $foto_anggota_1->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_2' => $foto_anggota_2 ? $foto_anggota_2->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_3' => $foto_anggota_3 ? $foto_anggota_3->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_4' => $foto_anggota_4 ? $foto_anggota_4->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
				'anggota_cadangan' => $foto_anggota_cadangan ? $foto_anggota_cadangan->store('olahraga/esports/pointblank/' . $row_id, ["disk" => 'pendaftaran']) : "",
			],
		];
		...
		return redirect()->route('landing.olahraga.esports.pointblank.success')->with('status', 'SUKSES!');
	}
	...
	public function success()
	{
		if (session('status')) {
			...
			return redirect()->route('landing.olahraga.esports.pointblank.index');
		}
	}
}
